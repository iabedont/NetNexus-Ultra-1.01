...
public class ModernVehicleWindow extends JFrame {
    ...
    private void createVehicleTableIfNotExists(Connection conn) throws SQLException {
        // Verificar si la tabla vehiculos existe y tiene la estructura correcta
        try {
            DatabaseMetaData metaData = conn.getMetaData();
            ResultSet tables = metaData.getTables(null, null, "vehiculos", null);
            ...
            logger.log(Level.WARNING, "No se pudo crear la tabla vehiculos: " + e.getMessage());
        }
    }
