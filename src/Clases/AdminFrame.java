...
public class AdminFrame extends JFrame {
    ...
    public AdminFrame() {
        ...
        equipmentButton.addActionListener(e -> {
            JOptionPane.showMessageDialog(this, "Gestión de Equipos - En desarrollo", "Información", JOptionPane.INFORMATION_MESSAGE);
        });
        ...
        ticketButton.addActionListener(e -> {
            JOptionPane.showMessageDialog(this, "Gestión de Tickets - En desarrollo", "Información", JOptionPane.INFORMATION_MESSAGE);
        });
        ...
        vehicleButton.addActionListener(e -> {
            JOptionPane.showMessageDialog(this, "Gestión de Vehículos - En desarrollo", "Información", JOptionPane.INFORMATION_MESSAGE);
        });
