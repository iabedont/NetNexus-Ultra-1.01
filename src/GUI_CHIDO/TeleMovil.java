...
public class TeleMovil extends javax.swing.JFrame {
    ...
    public TeleMovil(JFrame parentFrame, int clienteId) { // Nuevo constructor
    ...
    // Si tienes botones para contratar planes de Móvil que abran Facturación,
    // asegúrate de pasar el currentClienteId:
    // private void jButtonContratarMovilPlanActionPerformed(java.awt.event.ActionEvent evt) {
    //     Facturación facturacionFrame = new Facturación("Plan Móvil Premium", 40.00, currentClienteId);
