...
public class TeleFija extends javax.swing.JFrame {
    ...
    public TeleFija(JFrame parentFrame, int clienteId) { // Nuevo constructor
    ...
    // Si tienes botones para contratar planes de Telefonía Fija que abran Facturación,
    // asegúrate de pasar el currentClienteId:
    // private void jButtonContratarFijaPlanActionPerformed(java.awt.event.ActionEvent evt) {
    //     Facturación facturacionFrame = new Facturación("Plan Fija Ilimitado", 15.00, currentClienteId);
