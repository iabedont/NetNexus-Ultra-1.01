...
-- ================================================================
-- TÉCNICOS (Verificar que existan vehículos primero)
-- ================================================================
...
SELECT 
    'VERIFICACION: Clientes por tipo' as Resultado,
    tipo, 
    COUNT(*) as cantidad
FROM cliente 
GROUP BY tipo
...
-- Verificar total de registros principales
SELECT 
    ...
    (SELECT COUNT(*) FROM ubicacion WHERE ciudad = 'Ibarra') as Ubicaciones_Ibarra;

-- ================================================================
-- CONFIRMACIÓN EXITOSA
-- ================================================================
SELECT 'MIGRACION COMPLETADA EXITOSAMENTE - DATOS DE IBARRA, IMBABURA' as Estado_Final;
